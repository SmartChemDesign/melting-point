...
SAVE_PATH = "finetuned_molformer_original"
LEARNING_RATE = 4e-5
WEIGHT_DECAY = 0.001
GRAD_CLIP = 1.0
PATIENCE = 5  # Early stopping patience
N_RUNS = 3    # Amount of runs


df = pd.read_csv("/home/dubonos/MELTING-POINT-1/main_mp_df.csv") ## put your path here
...
def run_single_run(seed, run_number):
    ...
    class MPModel(nn.Module):
        def __init__(self):
            ...
            self.head = nn.Linear(self.molformer.config.hidden_size, 1)
...
if __name__ == "__main__":
    seeds = [42, 123, 2024]  # 3 different seeds
